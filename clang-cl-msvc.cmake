...
if(XWIN_SPLAT)
  ...
  if(NOT EXISTS "${XWIN_SPLAT}" OR
     NOT EXISTS "${MSVC_INCLUDE}" OR
     NOT EXISTS "${MSVC_LIB}" OR
     NOT EXISTS "${WINSDK_INCLUDE}" OR
     NOT EXISTS "${WINSDK_LIB}")
    message(SEND_ERROR
            "CMake variable XWIN_SPLAT must point to the \"splat\" folder "
            "generated by Jake-Shadle's xwin")
  endif()
else()
...
find_program(CLANG_CL_PATH NAMES clang-cl clang-cl-${CLANG_VER})
...
find_program(LLD_LINK_PATH NAMES lld-link lld-link-${LLVM_VER})
...
find_program(LLVM_LIB_PATH NAMES llvm-lib llvm-lib-${LLVM_VER})
...
find_program(LLVM_NM_PATH NAMES llvm-nm llvm-nm-${LLVM_VER})
...
find_program(LLVM_MT_PATH NAMES llvm-mt llvm-mt-${LLVM_VER})
